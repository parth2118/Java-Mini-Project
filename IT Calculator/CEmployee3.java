...
class CEmployee3 extends CEmployee2 {
    ...
    CEmployee3(String name, String PAN, int age, String email, double grossSal, int CityOfResidence, double basicSal_DA,
        ...
        this.deduction_Sec_80C = -1
                * (deduction_Sec_80C >= deduction_Sec_80C_lim ? deduction_Sec_80C_lim : deduction_Sec_80C);
    ...
    public String toString() {
        return " 80C " + getDeduction_sec_80C() + " 80CCD NPS " + getdeduction_Sec_80CCD_NPS() + " 80CCG "
                + getdeduction_Sec_80CCG();
    }

}
/*
 * class cEmployee3 { public static void main(String[] args) { cEmployee e = new
 * cEmployee("dc", "edc", "1985-10-01", 900000.0, 1, 800000.0, 300000.0, 500.0,
 * 40000.0, 50000.0, 10000.0, 30000, 5000, 5000, 100000.0, 40000.0, 40000);

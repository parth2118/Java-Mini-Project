...
class CEmployee1 extends CPerson
{
    ...
    CEmployee1(String name, String PAN, int age, String email,
                ...
                double standard_deduction_Salaried_Pensioner, double other_excempted, double professional_tax)
                {
                    ...
                    this.basicSal_DA = (CityOfResidence == 1 ? basicSal_DA*basicSal_DA_mul_Metro : basicSal_DA*basicSal_DA_mul_N_Metro);
                    this.rentPaid = rentPaid - rent_mul*this.basicSal_DA;
                    this.HRArecieved = HRArecieved;
                    this.standard_deduction_Salaried_Pensioner = Math.max(Math.min(standard_deduction_Salaried_Pensioner, standard_deduction_Salaried_Pensioner_limit), 0);
                    ...
                    this.allowencesExcepted = -1 * (this.HRAexception + this.standard_deduction_Salaried_Pensioner + this.other_excempted + this.professional_tax);
    ...
    {
        return "gross anual sal " + this.grossSal + " allownces excempted " + this.allowencesExcepted + " income under head sal " + this.income_under_head_sal;
    }
}
